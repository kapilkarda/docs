...
description: "This page will teach us how to add contacts to the contact list"
icon: "people"
---

The process of adding contacts to a [contact list](https://app.precallai.com/admin/contact-list) is as quite simple. <br/> We can bulk upload contacts to a contact list via a .csv file or we can add the contacts manually.
