...
The process of adding contacts to a [contact list](https://app.precallai.com/admin/segments) is as quite simple. <br/> We can bulk upload contacts to a segment list via a .csv file or we can add the contacts manually.
